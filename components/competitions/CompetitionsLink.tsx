...
/** Lien secondaire stack `/competitions` — pas un onglet (Ligues reste `href: null`). */
export function CompetitionsLink() {
  return (
    <Pressable
      onPress={() => router.push("/competitions")}
      accessibilityRole="button"
      accessibilityLabel="Compétitions"
    ...
    >
      ...
      <Text className="font-bold text-fg">Compétitions</Text>
    </Pressable>
  );
}
