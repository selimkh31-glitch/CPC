...
export const PLAYER_CARD_COPY = {
  ...
  linkPlayer: "Lier mon joueur EA",
  changeClub: "Changer de club",
  eaIdLabel: "ID EA",
  eaUnlinked: "Pas encore lié — tu peux jouer sans. Lier le club + le même pseudo EA, c'est lier le joueur.",
  eaLinkedPending: "Club lié. Ton pseudo CPC n'apparaît pas encore parmi les membres EA — pas de stats inventées.",
  eaLinkedBound: "Joueur lié : ton pseudo CPC correspond à un membre du club EA.",
  eaGoals: "Buts EA",
  eaAssists: "Passes EA",
  eaMatches: "Matchs EA",
  eaRating: "Note EA",
